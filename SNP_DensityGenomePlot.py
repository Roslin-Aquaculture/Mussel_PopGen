...
def main():
    full_snp_file = "TOL_Med_SNP Pos.txt" #Ensure this reference file is present
    filtered_snp_file = "Shetland_elai.recode.pos.txt" #Any of these files used should work. It's just to get the lsit of filtered SNPs. 
    title_base = "xbMytEdul2.2" # The name of the assembly mapped against
